-- ============================================================
-- SEED SQL - HUNGO GASTRONOMIA (Idempotente com INSERT IGNORE)
-- Pode ser executado repetidamente no MySQL sem erro de chave duplicada
-- ============================================================
...
-- 3. PRODUTOS (30 PRODUTOS - 6 FAVORITOS)
...
INSERT IGNORE INTO Produto (id, nome, preco, tipo, favorito, categoria_id) VALUES (7, 'X-Salada Clássico', 26.90, true, false, 1);
INSERT IGNORE INTO Produto (id, nome, preco, tipo, favorito, categoria_id) VALUES (8, 'Burger Vegetariano Grão de Bico', 31.00, true, false, 1);
INSERT IGNORE INTO Produto (id, nome, preco, tipo, favorito, categoria_id) VALUES (9, 'Monster Burger 360g Duplo', 42.90, true, false, 1);
INSERT IGNORE INTO Produto (id, nome, preco, tipo, favorito, categoria_id) VALUES (10, 'Chicken Crispy Burger', 28.50, true, false, 1);
INSERT IGNORE INTO Produto (id, nome, preco, tipo, favorito, categoria_id) VALUES (11, 'X-Tudo da Casa Completo', 39.90, true, false, 1);
INSERT IGNORE INTO Produto (id, nome, preco, tipo, favorito, categoria_id) VALUES (12, 'Smash Egg & Bacon', 27.90, true, false, 1);
