...
const PedidoList = () => {
    ...
    const [pedidoSelecionado, setPedidoSelecionado] = useState(null); // Pedido a ser deletado
    const navigate = useNavigate();
    ...
    const handleDeletePedido = async () => {
        ...
        try {
            ...
            setPedidos(pedidos.filter((pedido) => pedido.id !== pedidoSelecionado.id)); // Remove da lista local
