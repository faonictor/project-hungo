                    ...
                    <form onSubmit={handleSubmit} className="mt-8 max-w-screen-lg lg:w-full mx-auto">
                        <div className="mb-1 grid grid-cols-1 sm:grid-cols-8 gap-6">
                            <div className="col-span-1 sm:col-span-5">
                                <InputField label="Nome" placeholder="ex.: Ingrediente" value={nome} onChange={setNome} />
                            </div>
                            <div className="col-span-1 sm:col-span-1">
                                <InputField label="Preço" type="number" placeholder="ex.: 9,99" value={preco} onChange={setPreco} />
                            </div>
                            <div className="col-span-1 sm:col-span-1">
                                <InputField label="Quantidade" type="number" placeholder="ex.: 10" value={quantidade} onChange={setQuantidade} />
                            </div>
                            <div className="col-span-1 sm:col-span-1">
                                <InputField label="Unidade" placeholder="ex.: kg, unidade" value={unidadeMedida} onChange={setUnidadeMedida} />
                            </div>
                    ...
                    <div className="overflow-x-auto w-full md:w-1/2 bg-white shadow-md rounded-lg mt-8">
                        <table className="min-w-full table-auto">
                            ...
                            <tr>
                                ...
                                <th className="px-4 py-2 border-b text-left">Unidade</th>
